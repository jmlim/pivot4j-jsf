...
(function() {
  ...
  var cKeywords = "abort accept access add alter and any array arraylen as asc assert assign at attributes audit " +
        "authorization avg " +
        "base_table begin between binary_integer body boolean by " +
        "case cast char char_base check close cluster clusters colauth columns comment commit compress connect " +
        "connected constant constraint crash create crossjoin current currval cursor " +
